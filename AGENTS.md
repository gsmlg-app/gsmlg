...
This project is indexed by GitNexus as **gsmlg** (26344 symbols, 60188 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
