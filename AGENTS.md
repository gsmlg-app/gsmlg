...
This project is indexed by GitNexus as **gsmlg** (26618 symbols, 61019 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
