...
This project is indexed by GitNexus as **gsmlg** (25692 symbols, 58096 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
