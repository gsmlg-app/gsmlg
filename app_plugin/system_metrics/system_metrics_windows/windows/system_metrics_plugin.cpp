#include "system_metrics_plugin.h"
...
namespace system_metrics_windows {

class SystemMetricsPlugin : public flutter::Plugin {
 public:
  static void RegisterWithRegistrar(flutter::PluginRegistrarWindows *registrar);

  SystemMetricsPlugin();

  virtual ~SystemMetricsPlugin();

  SystemMetricsPlugin(const SystemMetricsPlugin&) = delete;
  SystemMetricsPlugin& operator=(const SystemMetricsPlugin&) = delete;
...
void SystemMetricsPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows *registrar) {
  auto channel =
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "app_system_metrics",
          &flutter::StandardMethodCodec::GetInstance());

  auto plugin = std::make_unique<SystemMetricsPlugin>();
...
SystemMetricsPlugin::SystemMetricsPlugin() {}

SystemMetricsPlugin::~SystemMetricsPlugin() {}

std::string SystemMetricsPlugin::GetCurrentTimestamp() {
...
flutter::EncodableMap SystemMetricsPlugin::GetData() {
  if (has_cached_data_) {
    return cached_data_;
  }
...
void SystemMetricsPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue> &method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void SystemMetricsPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  system_metrics_windows::SystemMetricsPlugin::RegisterWithRegistrar(
