...
This project is indexed by GitNexus as **gsmlg** (24692 symbols, 51446 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
