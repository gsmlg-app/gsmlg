...
This project is indexed by GitNexus as **gsmlg** (26698 symbols, 61217 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
