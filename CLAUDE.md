...
This project is indexed by GitNexus as **gsmlg** (25066 symbols, 51222 relationships, 120 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
