...
class GetInstanceNeighbors200Response {
  /// Returns a new [GetInstanceNeighbors200Response] instance.
  ...
  /// Returns a new [GetInstanceNeighbors200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetInstanceNeighbors200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetInstanceNeighbors200Response> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetInstanceNeighbors200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetInstanceNeighbors200Response> mapFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = GetInstanceNeighbors200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
