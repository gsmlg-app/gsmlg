...
class UpdatePushzoneRequest {
  /// Returns a new [UpdatePushzoneRequest] instance.
  ...
  /// Returns a new [UpdatePushzoneRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdatePushzoneRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UpdatePushzoneRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdatePushzoneRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdatePushzoneRequest> mapFromJson(dynamic json) {
    final map = <String, UpdatePushzoneRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdatePushzoneRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
