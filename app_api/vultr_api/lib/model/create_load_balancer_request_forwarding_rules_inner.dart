...
class CreateLoadBalancerRequestForwardingRulesInner {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateLoadBalancerRequestForwardingRulesInner &&
  ...
  @override
  String toString() => 'CreateLoadBalancerRequestForwardingRulesInner[frontendProtocol=$frontendProtocol, frontendPort=$frontendPort, backendProtocol=$backendProtocol, backendPort=$backendPort]';
  ...
  static CreateLoadBalancerRequestForwardingRulesInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateLoadBalancerRequestForwardingRulesInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateLoadBalancerRequestForwardingRulesInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateLoadBalancerRequestForwardingRulesInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <CreateLoadBalancerRequestForwardingRulesInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancerRequestForwardingRulesInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateLoadBalancerRequestForwardingRulesInner> mapFromJson(dynamic json) {
    final map = <String, CreateLoadBalancerRequestForwardingRulesInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateLoadBalancerRequestForwardingRulesInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<CreateLoadBalancerRequestForwardingRulesInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateLoadBalancerRequestForwardingRulesInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateLoadBalancerRequestForwardingRulesInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
