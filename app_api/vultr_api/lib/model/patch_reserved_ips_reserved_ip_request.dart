...
class PatchReservedIpsReservedIpRequest {
  /// Returns a new [PatchReservedIpsReservedIpRequest] instance.
  ...
  /// Returns a new [PatchReservedIpsReservedIpRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PatchReservedIpsReservedIpRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PatchReservedIpsReservedIpRequest(
  ...
  static List<PatchReservedIpsReservedIpRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PatchReservedIpsReservedIpRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PatchReservedIpsReservedIpRequest> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = PatchReservedIpsReservedIpRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
