...
class StartKubernetesClusterUpgradeRequest {
  /// Returns a new [StartKubernetesClusterUpgradeRequest] instance.
  ...
  /// Returns a new [StartKubernetesClusterUpgradeRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static StartKubernetesClusterUpgradeRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return StartKubernetesClusterUpgradeRequest(
        upgradeVersion: mapValueOfType<String>(json, r'upgrade_version')!,
      );
    }
    return null;
  }
  ...
  static List<StartKubernetesClusterUpgradeRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = StartKubernetesClusterUpgradeRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
