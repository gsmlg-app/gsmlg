...
class UploadendpointInputs {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UploadendpointInputs &&
    other.acl == acl &&
    other.key == key &&
  ...
  @override
  String toString() => 'UploadendpointInputs[acl=$acl, key=$key, xAmzCredential=$xAmzCredential, xAmzAlgorithm=$xAmzAlgorithm, policy=$policy, xAmzSignature=$xAmzSignature]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "UploadendpointInputs[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "UploadendpointInputs[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UploadendpointInputs> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<UploadendpointInputs>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<UploadendpointInputs>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = UploadendpointInputs.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
