...
class VfsAttachment {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is VfsAttachment &&
    other.state == state &&
    other.vfsId == vfsId &&
  ...
  @override
  String toString() => 'VfsAttachment[state=$state, vfsId=$vfsId, targetId=$targetId, mountTag=$mountTag]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "VfsAttachment[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "VfsAttachment[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<VfsAttachment> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<VfsAttachment>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<VfsAttachment>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = VfsAttachment.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
