...
class AttachVpc2NodesRequest {
  /// Returns a new [AttachVpc2NodesRequest] instance.
  ...
  /// Returns a new [AttachVpc2NodesRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AttachVpc2NodesRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<AttachVpc2NodesRequest> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AttachVpc2NodesRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AttachVpc2NodesRequest> mapFromJson(dynamic json) {
    final map = <String, AttachVpc2NodesRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AttachVpc2NodesRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
