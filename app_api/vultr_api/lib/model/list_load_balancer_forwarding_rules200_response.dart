...
class ListLoadBalancerForwardingRules200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListLoadBalancerForwardingRules200Response &&
  ...
  @override
  String toString() => 'ListLoadBalancerForwardingRules200Response[forwardingRules=$forwardingRules, meta=$meta]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListLoadBalancerForwardingRules200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListLoadBalancerForwardingRules200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListLoadBalancerForwardingRules200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, ListLoadBalancerForwardingRules200Response> mapFromJson(dynamic json) {
    final map = <String, ListLoadBalancerForwardingRules200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListLoadBalancerForwardingRules200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ListLoadBalancerForwardingRules200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ListLoadBalancerForwardingRules200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ListLoadBalancerForwardingRules200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
