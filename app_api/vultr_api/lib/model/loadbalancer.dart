...
class Loadbalancer {
  ...
  static Loadbalancer? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Loadbalancer[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Loadbalancer[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Loadbalancer(
        ...
        forwardRules:
            LoadbalancerForwardRulesInner.listFromJson(json[r'forward_rules']),
        instances: json[r'instances'] is Iterable
            ? (json[r'instances'] as Iterable)
                .cast<String>()
                .toList(growable: false)
            : const [],
        firewallRules: LoadbalancerFirewallRulesInner.listFromJson(
        ...
        globalChildrenIds: json[r'global_children_ids'] is Iterable
            ? (json[r'global_children_ids'] as Iterable)
                .cast<String>()
                .toList(growable: false)
            : const [],
  ...
  static List<Loadbalancer> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Loadbalancer>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Loadbalancer.listFromJson(
          entry.value,
          growable: growable,
        );
      }
