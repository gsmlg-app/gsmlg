...
class CreatePushzone201Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreatePushzone201Response && other.pushZone == pushZone;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CreatePushzone201Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CreatePushzone201Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreatePushzone201Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CreatePushzone201Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreatePushzone201Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
