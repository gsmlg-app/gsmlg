...
class ListObjectStorageClusters200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListObjectStorageClusters200Response &&
  ...
  int get hashCode =>
      ...
      (clusters.hashCode) + (meta == null ? 0 : meta!.hashCode);

  @override
  String toString() =>
      'ListObjectStorageClusters200Response[clusters=$clusters, meta=$meta]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ListObjectStorageClusters200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ListObjectStorageClusters200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListObjectStorageClusters200Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, ListObjectStorageClusters200Response> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            ListObjectStorageClusters200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<ListObjectStorageClusters200Response>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ListObjectStorageClusters200Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
