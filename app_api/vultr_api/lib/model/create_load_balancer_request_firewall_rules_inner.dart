...
class CreateLoadBalancerRequestFirewallRulesInner {
  /// Returns a new [CreateLoadBalancerRequestFirewallRulesInner] instance.
  ...
  /// Returns a new [CreateLoadBalancerRequestFirewallRulesInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateLoadBalancerRequestFirewallRulesInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateLoadBalancerRequestFirewallRulesInner(
  ...
  static List<CreateLoadBalancerRequestFirewallRulesInner> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancerRequestFirewallRulesInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
