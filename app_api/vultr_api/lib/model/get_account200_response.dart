...
class GetAccount200Response {
  /// Returns a new [GetAccount200Response] instance.
  ...
  /// Returns a new [GetAccount200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetAccount200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GetAccount200Response> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetAccount200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, GetAccount200Response> mapFromJson(dynamic json) {
    final map = <String, GetAccount200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = GetAccount200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
