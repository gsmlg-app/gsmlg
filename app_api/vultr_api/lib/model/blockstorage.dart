...
class Blockstorage {
  ...
  @override
  String toString() =>
      'Blockstorage[id=$id, cost=$cost, status=$status, sizeGb=$sizeGb, region=$region, attachedToInstance=$attachedToInstance, dateCreated=$dateCreated, label=$label, mountId=$mountId]';
  ...
  static Blockstorage? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "Blockstorage[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "Blockstorage[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return Blockstorage(
        ...
        attachedToInstance:
            mapValueOfType<String>(json, r'attached_to_instance'),
  ...
  static List<Blockstorage> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<Blockstorage>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = Blockstorage.listFromJson(
          entry.value,
          growable: growable,
        );
      }
