...
class LoadbalancerAutoSsl {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LoadbalancerAutoSsl &&
  ...
  @override
  String toString() => 'LoadbalancerAutoSsl[domainZone=$domainZone, domain=$domain]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "LoadbalancerAutoSsl[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "LoadbalancerAutoSsl[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<LoadbalancerAutoSsl> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<LoadbalancerAutoSsl>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<LoadbalancerAutoSsl>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = LoadbalancerAutoSsl.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
