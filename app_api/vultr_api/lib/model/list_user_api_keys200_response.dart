...
class ListUserApiKeys200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListUserApiKeys200Response &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ListUserApiKeys200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ListUserApiKeys200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListUserApiKeys200Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ListUserApiKeys200Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ListUserApiKeys200Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
