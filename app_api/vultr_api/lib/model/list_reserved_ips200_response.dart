...
class ListReservedIps200Response {
  /// Returns a new [ListReservedIps200Response] instance.
  ...
  /// Returns a new [ListReservedIps200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListReservedIps200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ListReservedIps200Response(
        reservedIps: ReservedIp.listFromJson(json[r'reserved_ips']),
  ...
  static List<ListReservedIps200Response> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListReservedIps200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListReservedIps200Response> mapFromJson(dynamic json) {
    final map = <String, ListReservedIps200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListReservedIps200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
