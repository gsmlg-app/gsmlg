...
class CreateBaremetalReverseIpv6Request {
  /// Returns a new [CreateBaremetalReverseIpv6Request] instance.
  ...
  /// Returns a new [CreateBaremetalReverseIpv6Request] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateBaremetalReverseIpv6Request? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateBaremetalReverseIpv6Request(
  ...
  static List<CreateBaremetalReverseIpv6Request> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateBaremetalReverseIpv6Request.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateBaremetalReverseIpv6Request> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = CreateBaremetalReverseIpv6Request.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
