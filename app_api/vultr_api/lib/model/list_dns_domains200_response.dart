...
class ListDnsDomains200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ListDnsDomains200Response &&
  ...
  @override
  String toString() => 'ListDnsDomains200Response[domains=$domains, meta=$meta]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ListDnsDomains200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ListDnsDomains200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ListDnsDomains200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ListDnsDomains200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ListDnsDomains200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ListDnsDomains200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
