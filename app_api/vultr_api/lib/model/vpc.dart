...
class Vpc {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.internet != null) {
      json[r'internet'] = this.internet;
    } else {
      json[r'internet'] = null;
    }
    return json;
  }

  /// Returns a new [Vpc] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Vpc? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Vpc(
        ...
        internet: VpcInternet.fromJson(json[r'internet']),
      );
    }
    return null;
  }
  ...
  static Map<String, Vpc> mapFromJson(dynamic json) {
    final map = <String, Vpc>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Vpc.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
