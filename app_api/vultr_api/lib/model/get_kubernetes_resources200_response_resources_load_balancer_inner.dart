...
class GetKubernetesResources200ResponseResourcesLoadBalancerInner {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetKubernetesResources200ResponseResourcesLoadBalancerInner &&
          other.id == id &&
          other.label == label &&
  ...
  @override
  String toString() =>
      'GetKubernetesResources200ResponseResourcesLoadBalancerInner[id=$id, label=$label, dateCreated=$dateCreated, status=$status]';
  ...
  static GetKubernetesResources200ResponseResourcesLoadBalancerInner? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetKubernetesResources200ResponseResourcesLoadBalancerInner[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetKubernetesResources200ResponseResourcesLoadBalancerInner[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetKubernetesResources200ResponseResourcesLoadBalancerInner>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String,
    ...
    final map =
        <String, GetKubernetesResources200ResponseResourcesLoadBalancerInner>{};
  ...
  static Map<String,
          List<GetKubernetesResources200ResponseResourcesLoadBalancerInner>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
