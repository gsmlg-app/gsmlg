...
class GetInvoice200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetInvoice200Response &&
    other.billingInvoice == billingInvoice;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetInvoice200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetInvoice200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetInvoice200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetInvoice200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetInvoice200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetInvoice200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
