...
class CreateStorageGateway202Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateStorageGateway202Response &&
  ...
  @override
  String toString() => 'CreateStorageGateway202Response[storageGateway=$storageGateway]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateStorageGateway202Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateStorageGateway202Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateStorageGateway202Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, CreateStorageGateway202Response> mapFromJson(dynamic json) {
  ...
  static Map<String, List<CreateStorageGateway202Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateStorageGateway202Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateStorageGateway202Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
