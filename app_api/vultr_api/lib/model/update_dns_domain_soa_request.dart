...
class UpdateDnsDomainSoaRequest {
  /// Returns a new [UpdateDnsDomainSoaRequest] instance.
  ...
  /// Returns a new [UpdateDnsDomainSoaRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateDnsDomainSoaRequest? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UpdateDnsDomainSoaRequest(
  ...
  static List<UpdateDnsDomainSoaRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateDnsDomainSoaRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateDnsDomainSoaRequest> mapFromJson(dynamic json) {
    final map = <String, UpdateDnsDomainSoaRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateDnsDomainSoaRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
