...
class CreateObjectStorage202Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CreateObjectStorage202Response &&
  ...
  @override
  String toString() => 'CreateObjectStorage202Response[objectStorage=$objectStorage]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "CreateObjectStorage202Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "CreateObjectStorage202Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateObjectStorage202Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<CreateObjectStorage202Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<CreateObjectStorage202Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CreateObjectStorage202Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
