...
class CreateDnsDomainRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateDnsDomainRequest &&
          other.domain == domain &&
          other.ip == ip &&
          other.dnsSec == dnsSec;
  ...
  @override
  String toString() =>
      'CreateDnsDomainRequest[domain=$domain, ip=$ip, dnsSec=$dnsSec]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CreateDnsDomainRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CreateDnsDomainRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateDnsDomainRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CreateDnsDomainRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreateDnsDomainRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
