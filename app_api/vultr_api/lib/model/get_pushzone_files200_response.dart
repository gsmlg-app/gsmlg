...
class GetPushzoneFiles200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetPushzoneFiles200Response &&
  ...
  @override
  String toString() => 'GetPushzoneFiles200Response[files=$files, count=$count, totalSize=$totalSize]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetPushzoneFiles200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetPushzoneFiles200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetPushzoneFiles200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetPushzoneFiles200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetPushzoneFiles200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetPushzoneFiles200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
