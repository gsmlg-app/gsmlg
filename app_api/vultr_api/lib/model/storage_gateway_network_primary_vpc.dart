...
class StorageGatewayNetworkPrimaryVpc {
  ...
  bool operator ==(Object other) =>
      ...
      other is StorageGatewayNetworkPrimaryVpc && other.vpcUuid == vpcUuid;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "StorageGatewayNetworkPrimaryVpc[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "StorageGatewayNetworkPrimaryVpc[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<StorageGatewayNetworkPrimaryVpc> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, StorageGatewayNetworkPrimaryVpc> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<StorageGatewayNetworkPrimaryVpc>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = StorageGatewayNetworkPrimaryVpc.listFromJson(
          entry.value,
          growable: growable,
        );
      }
