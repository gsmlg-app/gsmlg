...
class UpdateInferenceRequest {
  /// Returns a new [UpdateInferenceRequest] instance.
  ...
  /// Returns a new [UpdateInferenceRequest] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static UpdateInferenceRequest? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<UpdateInferenceRequest> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = UpdateInferenceRequest.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, UpdateInferenceRequest> mapFromJson(dynamic json) {
    final map = <String, UpdateInferenceRequest>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = UpdateInferenceRequest.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
