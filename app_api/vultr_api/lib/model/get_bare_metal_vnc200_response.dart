...
class GetBareMetalVnc200Response {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetBareMetalVnc200Response &&
    other.vnc == vnc;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetBareMetalVnc200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetBareMetalVnc200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetBareMetalVnc200Response> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetBareMetalVnc200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetBareMetalVnc200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetBareMetalVnc200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
