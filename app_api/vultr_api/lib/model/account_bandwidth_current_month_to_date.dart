...
class AccountBandwidthCurrentMonthToDate {
  ...
  bool operator ==(Object other) =>
      ...
      other is AccountBandwidthCurrentMonthToDate &&
  ...
  @override
  String toString() =>
      'AccountBandwidthCurrentMonthToDate[timestampStart=$timestampStart, timestampEnd=$timestampEnd, gbIn=$gbIn, gbOut=$gbOut, totalInstanceHours=$totalInstanceHours, totalInstanceCount=$totalInstanceCount, instanceBandwidthCredits=$instanceBandwidthCredits, freeBandwidthCredits=$freeBandwidthCredits, purchasedBandwidthCredits=$purchasedBandwidthCredits, overage=$overage, overageUnitCost=$overageUnitCost, overageCost=$overageCost]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AccountBandwidthCurrentMonthToDate[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AccountBandwidthCurrentMonthToDate[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountBandwidthCurrentMonthToDate> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, AccountBandwidthCurrentMonthToDate> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<AccountBandwidthCurrentMonthToDate>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AccountBandwidthCurrentMonthToDate.listFromJson(
          entry.value,
          growable: growable,
        );
      }
