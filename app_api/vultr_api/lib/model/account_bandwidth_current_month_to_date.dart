...
class AccountBandwidthCurrentMonthToDate {
  /// Returns a new [AccountBandwidthCurrentMonthToDate] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AccountBandwidthCurrentMonthToDate &&
  ...
  @override
  String toString() => 'AccountBandwidthCurrentMonthToDate[timestampStart=$timestampStart, timestampEnd=$timestampEnd, gbIn=$gbIn, gbOut=$gbOut, totalInstanceHours=$totalInstanceHours, totalInstanceCount=$totalInstanceCount, instanceBandwidthCredits=$instanceBandwidthCredits, freeBandwidthCredits=$freeBandwidthCredits, purchasedBandwidthCredits=$purchasedBandwidthCredits, overage=$overage, overageUnitCost=$overageUnitCost, overageCost=$overageCost]';
  ...
  /// Returns a new [AccountBandwidthCurrentMonthToDate] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static AccountBandwidthCurrentMonthToDate? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AccountBandwidthCurrentMonthToDate[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AccountBandwidthCurrentMonthToDate[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return AccountBandwidthCurrentMonthToDate(
  ...
  static List<AccountBandwidthCurrentMonthToDate> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <AccountBandwidthCurrentMonthToDate>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = AccountBandwidthCurrentMonthToDate.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, AccountBandwidthCurrentMonthToDate> mapFromJson(dynamic json) {
    final map = <String, AccountBandwidthCurrentMonthToDate>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = AccountBandwidthCurrentMonthToDate.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of AccountBandwidthCurrentMonthToDate-objects as value to a dart map
  static Map<String, List<AccountBandwidthCurrentMonthToDate>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AccountBandwidthCurrentMonthToDate>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AccountBandwidthCurrentMonthToDate.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
