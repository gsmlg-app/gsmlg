...
class InferenceUsage {
  ...
  bool operator ==(Object other) =>
      ...
      other is InferenceUsage && other.chat == chat && other.audio == audio;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "InferenceUsage[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "InferenceUsage[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InferenceUsage> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<InferenceUsage>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = InferenceUsage.listFromJson(
          entry.value,
          growable: growable,
        );
      }
