...
class Bandwidth {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.incomingBytes != null) {
      json[r'incoming_bytes'] = this.incomingBytes;
    } else {
      json[r'incoming_bytes'] = null;
    }
    if (this.outgoingBytes != null) {
      json[r'outgoing_bytes'] = this.outgoingBytes;
    } else {
      json[r'outgoing_bytes'] = null;
    }
    return json;
  }
  ...
  static Bandwidth? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return Bandwidth(
        incomingBytes: mapValueOfType<int>(json, r'incoming_bytes'),
        outgoingBytes: mapValueOfType<int>(json, r'outgoing_bytes'),
      );
    }
    return null;
  }
