...
class GetInvoiceItems200ResponseMeta {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GetInvoiceItems200ResponseMeta &&
    other.total == total &&
    other.links == links;
  ...
  @override
  String toString() => 'GetInvoiceItems200ResponseMeta[total=$total, links=$links]';
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "GetInvoiceItems200ResponseMeta[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "GetInvoiceItems200ResponseMeta[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetInvoiceItems200ResponseMeta> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<GetInvoiceItems200ResponseMeta>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<GetInvoiceItems200ResponseMeta>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = GetInvoiceItems200ResponseMeta.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
