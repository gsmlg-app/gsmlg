...
class DetachInstanceVpc2Request {
  ...
  bool operator ==(Object other) =>
      ...
      other is DetachInstanceVpc2Request && other.vpcId == vpcId;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DetachInstanceVpc2Request[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DetachInstanceVpc2Request[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DetachInstanceVpc2Request> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DetachInstanceVpc2Request>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DetachInstanceVpc2Request.listFromJson(
          entry.value,
          growable: growable,
        );
      }
