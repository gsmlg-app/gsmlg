...
class CreateLoadBalancerRequestStickySession {
  /// Returns a new [CreateLoadBalancerRequestStickySession] instance.
  ...
  /// Returns a new [CreateLoadBalancerRequestStickySession] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateLoadBalancerRequestStickySession? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateLoadBalancerRequestStickySession(
  ...
  static List<CreateLoadBalancerRequestStickySession> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancerRequestStickySession.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
