...
class ListMarketplaceAppVariables200Response {
  /// Returns a new [ListMarketplaceAppVariables200Response] instance.
  ...
  /// Returns a new [ListMarketplaceAppVariables200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListMarketplaceAppVariables200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ListMarketplaceAppVariables200Response(
        variables: AppVariable.listFromJson(json[r'variables']),
      );
    }
    return null;
  }
  ...
  static List<ListMarketplaceAppVariables200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListMarketplaceAppVariables200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
