...
class InferenceUsageAudio {
  ...
  @override
  String toString() =>
      'InferenceUsageAudio[ttsCharacters=$ttsCharacters, ttsSmCharacters=$ttsSmCharacters]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "InferenceUsageAudio[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "InferenceUsageAudio[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InferenceUsageAudio> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<InferenceUsageAudio>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = InferenceUsageAudio.listFromJson(
          entry.value,
          growable: growable,
        );
      }
