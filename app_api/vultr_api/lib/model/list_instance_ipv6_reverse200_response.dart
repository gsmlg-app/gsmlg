...
class ListInstanceIpv6Reverse200Response {
  /// Returns a new [ListInstanceIpv6Reverse200Response] instance.
  ListInstanceIpv6Reverse200Response({
    this.reverseIpv6s = const [],
  });
  ...
  /// Returns a new [ListInstanceIpv6Reverse200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListInstanceIpv6Reverse200Response? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ListInstanceIpv6Reverse200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListInstanceIpv6Reverse200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListInstanceIpv6Reverse200Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ListInstanceIpv6Reverse200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
