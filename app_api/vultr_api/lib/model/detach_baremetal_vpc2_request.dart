...
class DetachBaremetalVpc2Request {
  ...
  bool operator ==(Object other) =>
      ...
      other is DetachBaremetalVpc2Request && other.vpcId == vpcId;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DetachBaremetalVpc2Request[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DetachBaremetalVpc2Request[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DetachBaremetalVpc2Request> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DetachBaremetalVpc2Request>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DetachBaremetalVpc2Request.listFromJson(
          entry.value,
          growable: growable,
        );
      }
