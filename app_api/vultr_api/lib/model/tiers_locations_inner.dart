...
class TiersLocationsInner {
  /// Returns a new [TiersLocationsInner] instance.
  TiersLocationsInner({
    this.hostname,
    this.id,
    this.name,
  ...
  /// Returns a new [TiersLocationsInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TiersLocationsInner? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<TiersLocationsInner> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TiersLocationsInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TiersLocationsInner> mapFromJson(dynamic json) {
    final map = <String, TiersLocationsInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TiersLocationsInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
