...
class CreatePushzoneUpload201Response {
  /// Returns a new [CreatePushzoneUpload201Response] instance.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.uploadEndpoint != null) {
      json[r'upload_endpoint'] = this.uploadEndpoint;
    } else {
      json[r'upload_endpoint'] = null;
    }
    return json;
  }

  /// Returns a new [CreatePushzoneUpload201Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreatePushzoneUpload201Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreatePushzoneUpload201Response(
        uploadEndpoint: Uploadendpoint.fromJson(json[r'upload_endpoint']),
      );
    }
    return null;
  }
  ...
  static List<CreatePushzoneUpload201Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreatePushzoneUpload201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreatePushzoneUpload201Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = CreatePushzoneUpload201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
