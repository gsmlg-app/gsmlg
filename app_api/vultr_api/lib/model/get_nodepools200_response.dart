...
class GetNodepools200Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is GetNodepools200Response &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "GetNodepools200Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "GetNodepools200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<GetNodepools200Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<GetNodepools200Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = GetNodepools200Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
