...
class ClusterTiers {
  /// Returns a new [ClusterTiers] instance.
  ClusterTiers({
    this.id,
    this.bwGbPrice,
    this.diskGbPrice,
  ...
  /// Returns a new [ClusterTiers] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ClusterTiers? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ClusterTiers> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ClusterTiers.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ClusterTiers> mapFromJson(dynamic json) {
    final map = <String, ClusterTiers>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ClusterTiers.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
