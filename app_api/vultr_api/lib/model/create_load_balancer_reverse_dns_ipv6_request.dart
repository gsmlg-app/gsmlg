...
class CreateLoadBalancerReverseDnsIpv6Request {
  /// Returns a new [CreateLoadBalancerReverseDnsIpv6Request] instance.
  ...
  /// Returns a new [CreateLoadBalancerReverseDnsIpv6Request] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateLoadBalancerReverseDnsIpv6Request? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CreateLoadBalancerReverseDnsIpv6Request> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancerReverseDnsIpv6Request.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
