...
class DetachInstanceVpcRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is DetachInstanceVpcRequest && other.vpcId == vpcId;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DetachInstanceVpcRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DetachInstanceVpcRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DetachInstanceVpcRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DetachInstanceVpcRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DetachInstanceVpcRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
