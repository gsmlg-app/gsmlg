...
class RestoreInstance202Response {
  /// Returns a new [RestoreInstance202Response] instance.
  ...
  /// Returns a new [RestoreInstance202Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static RestoreInstance202Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return RestoreInstance202Response(
        status: RestoreInstance202ResponseStatus.fromJson(json[r'status']),
      );
    }
    return null;
  }
  ...
  static List<RestoreInstance202Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = RestoreInstance202Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, RestoreInstance202Response> mapFromJson(dynamic json) {
    final map = <String, RestoreInstance202Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = RestoreInstance202Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
