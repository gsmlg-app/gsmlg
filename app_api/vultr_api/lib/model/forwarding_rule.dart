...
class ForwardingRule {
  /// Returns a new [ForwardingRule] instance.
  ForwardingRule({
    this.id,
  ...
  /// Returns a new [ForwardingRule] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ForwardingRule? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ForwardingRule> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ForwardingRule.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ForwardingRule> mapFromJson(dynamic json) {
    final map = <String, ForwardingRule>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ForwardingRule.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
