...
class StorageGatewayNetwork {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is StorageGatewayNetwork &&
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "StorageGatewayNetwork[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "StorageGatewayNetwork[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<StorageGatewayNetwork> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<StorageGatewayNetwork>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<StorageGatewayNetwork>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = StorageGatewayNetwork.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
