...
class ObjectStorages {
  /// Returns a new [ObjectStorages] instance.
  ObjectStorages({
    this.id,
    this.dateCreated,
    this.clusterId,
  ...
  /// Returns a new [ObjectStorages] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ObjectStorages? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ObjectStorages(
        ...
        tier: ObjectStoragesTier.fromJson(json[r'tier']),
      );
    }
    return null;
  }
  ...
  static List<ObjectStorages> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ObjectStorages.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ObjectStorages> mapFromJson(dynamic json) {
    final map = <String, ObjectStorages>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ObjectStorages.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
