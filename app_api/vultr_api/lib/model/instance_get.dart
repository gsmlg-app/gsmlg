...
class InstanceGet {
  /// Returns a new [InstanceGet] instance.
  InstanceGet({
    this.id,
    this.os,
    this.ram,
  ...
  /// Returns a new [InstanceGet] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static InstanceGet? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<InstanceGet> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = InstanceGet.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, InstanceGet> mapFromJson(dynamic json) {
    final map = <String, InstanceGet>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = InstanceGet.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
