...
class InferenceSubscription {
  ...
  bool operator ==(Object other) =>
      ...
      other is InferenceSubscription &&
          other.id == id &&
  ...
  @override
  String toString() =>
      'InferenceSubscription[id=$id, dateCreated=$dateCreated, label=$label, apiKey=$apiKey]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "InferenceSubscription[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "InferenceSubscription[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<InferenceSubscription> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<InferenceSubscription>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = InferenceSubscription.listFromJson(
          entry.value,
          growable: growable,
        );
      }
