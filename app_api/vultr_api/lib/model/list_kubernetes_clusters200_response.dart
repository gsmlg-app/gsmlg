...
class ListKubernetesClusters200Response {
  /// Returns a new [ListKubernetesClusters200Response] instance.
  ListKubernetesClusters200Response({
    this.vkeClusters = const [],
  });
  ...
  /// Returns a new [ListKubernetesClusters200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListKubernetesClusters200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ListKubernetesClusters200Response(
        vkeClusters: VkeCluster.listFromJson(json[r'vke_clusters']),
      );
    }
    return null;
  }
  ...
  static List<ListKubernetesClusters200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListKubernetesClusters200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListKubernetesClusters200Response> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value = ListKubernetesClusters200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
