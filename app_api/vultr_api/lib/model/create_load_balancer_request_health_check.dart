...
class CreateLoadBalancerRequestHealthCheck {
  /// Returns a new [CreateLoadBalancerRequestHealthCheck] instance.
  ...
  /// Returns a new [CreateLoadBalancerRequestHealthCheck] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateLoadBalancerRequestHealthCheck? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateLoadBalancerRequestHealthCheck(
  ...
  static List<CreateLoadBalancerRequestHealthCheck> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancerRequestHealthCheck.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
