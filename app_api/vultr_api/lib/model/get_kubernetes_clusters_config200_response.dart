...
class GetKubernetesClustersConfig200Response {
  /// Returns a new [GetKubernetesClustersConfig200Response] instance.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.kubeConfig != null) {
      json[r'kube_config'] = this.kubeConfig;
    } else {
      json[r'kube_config'] = null;
    }
    return json;
  }

  /// Returns a new [GetKubernetesClustersConfig200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetKubernetesClustersConfig200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetKubernetesClustersConfig200Response(
        kubeConfig: mapValueOfType<String>(json, r'kube_config'),
      );
    }
    return null;
  }
  ...
  static List<GetKubernetesClustersConfig200Response> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetKubernetesClustersConfig200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
