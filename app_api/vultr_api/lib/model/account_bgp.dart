...
class AccountBgp {
  ...
  @override
  String toString() =>
      'AccountBgp[asn=$asn, password=$password, enabled=$enabled]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "AccountBgp[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "AccountBgp[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AccountBgp> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<AccountBgp>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = AccountBgp.listFromJson(
          entry.value,
          growable: growable,
        );
      }
