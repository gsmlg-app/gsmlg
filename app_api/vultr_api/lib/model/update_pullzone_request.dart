...
class UpdatePullzoneRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is UpdatePullzoneRequest &&
          other.label == label &&
  ...
  @override
  String toString() =>
      'UpdatePullzoneRequest[label=$label, vanityDomain=$vanityDomain, sslCert=$sslCert, sslCertKey=$sslCertKey, cors=$cors, gzip=$gzip, blockAi=$blockAi, blockBadBots=$blockBadBots, regions=$regions]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "UpdatePullzoneRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "UpdatePullzoneRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<UpdatePullzoneRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<UpdatePullzoneRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = UpdatePullzoneRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
