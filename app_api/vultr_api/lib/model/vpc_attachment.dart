...
class VpcAttachment {
  ...
  @override
  String toString() =>
      'VpcAttachment[id=$id, type=$type, macAddress=$macAddress, dateAdded=$dateAdded, ip=$ip, linkedSubscription=$linkedSubscription]';
  ...
  static VpcAttachment? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "VpcAttachment[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "VpcAttachment[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return VpcAttachment(
        ...
        linkedSubscription: VpcAttachmentLinkedSubscription.fromJson(
            json[r'linked_subscription']),
      );
    }
    return null;
  }

  static List<VpcAttachment> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<VpcAttachment>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = VpcAttachment.listFromJson(
          entry.value,
          growable: growable,
        );
      }
