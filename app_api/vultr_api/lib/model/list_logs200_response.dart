...
class ListLogs200Response {
  /// Returns a new [ListLogs200Response] instance.
  ListLogs200Response({
    this.logs = const [],
    this.meta,
  });
  ...
  /// Returns a new [ListLogs200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ListLogs200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return ListLogs200Response(
        ...
        meta: LogMeta.fromJson(json[r'meta']),
      );
    }
    return null;
  }
  ...
  static List<ListLogs200Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ListLogs200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ListLogs200Response> mapFromJson(dynamic json) {
    final map = <String, ListLogs200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ListLogs200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
