...
class PostFirewallsFirewallGroupIdRules201Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is PostFirewallsFirewallGroupIdRules201Response &&
  ...
  @override
  String toString() =>
      'PostFirewallsFirewallGroupIdRules201Response[firewallRule=$firewallRule]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PostFirewallsFirewallGroupIdRules201Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PostFirewallsFirewallGroupIdRules201Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PostFirewallsFirewallGroupIdRules201Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            PostFirewallsFirewallGroupIdRules201Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PostFirewallsFirewallGroupIdRules201Response> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            PostFirewallsFirewallGroupIdRules201Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<PostFirewallsFirewallGroupIdRules201Response>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] =
            PostFirewallsFirewallGroupIdRules201Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
