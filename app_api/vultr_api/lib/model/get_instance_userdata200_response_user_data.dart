...
class GetInstanceUserdata200ResponseUserData {
  /// Returns a new [GetInstanceUserdata200ResponseUserData] instance.
  ...
  /// Returns a new [GetInstanceUserdata200ResponseUserData] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static GetInstanceUserdata200ResponseUserData? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return GetInstanceUserdata200ResponseUserData(
  ...
  static List<GetInstanceUserdata200ResponseUserData> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = GetInstanceUserdata200ResponseUserData.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
