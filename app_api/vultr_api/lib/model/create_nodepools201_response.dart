...
class CreateNodepools201Response {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateNodepools201Response && other.nodePool == nodePool;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CreateNodepools201Response[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CreateNodepools201Response[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<CreateNodepools201Response> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<CreateNodepools201Response>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = CreateNodepools201Response.listFromJson(
          entry.value,
          growable: growable,
        );
      }
