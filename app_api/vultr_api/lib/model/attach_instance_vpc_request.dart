...
class AttachInstanceVpcRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AttachInstanceVpcRequest &&
    other.vpcId == vpcId;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AttachInstanceVpcRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AttachInstanceVpcRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AttachInstanceVpcRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<AttachInstanceVpcRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AttachInstanceVpcRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AttachInstanceVpcRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
