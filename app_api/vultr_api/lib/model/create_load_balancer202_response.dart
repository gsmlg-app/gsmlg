...
class CreateLoadBalancer202Response {
  /// Returns a new [CreateLoadBalancer202Response] instance.
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.loadBalancer != null) {
      json[r'load_balancer'] = this.loadBalancer;
    } else {
      json[r'load_balancer'] = null;
    }
    return json;
  }

  /// Returns a new [CreateLoadBalancer202Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CreateLoadBalancer202Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return CreateLoadBalancer202Response(
        loadBalancer: Loadbalancer.fromJson(json[r'load_balancer']),
      );
    }
    return null;
  }
  ...
  static List<CreateLoadBalancer202Response> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CreateLoadBalancer202Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CreateLoadBalancer202Response> mapFromJson(dynamic json) {
    final map = <String, CreateLoadBalancer202Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CreateLoadBalancer202Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
