...
class Instance {
  ...
  @override
  String toString() => 'Instance[id=$id, os=$os, ram=$ram, disk=$disk, mainIp=$mainIp, vcpuCount=$vcpuCount, region=$region, defaultPassword=$defaultPassword, dateCreated=$dateCreated, status=$status, powerStatus=$powerStatus, serverStatus=$serverStatus, allowedBandwidth=$allowedBandwidth, netmaskV4=$netmaskV4, gatewayV4=$gatewayV4, v6Networks=$v6Networks, hostname=$hostname, label=$label, tag=$tag, internalIp=$internalIp, vpcOnly=$vpcOnly, kvm=$kvm, osId=$osId, appId=$appId, imageId=$imageId, snapshotId=$snapshotId, firewallGroupId=$firewallGroupId, features=$features, plan=$plan, tags=$tags, userScheme=$userScheme]';
