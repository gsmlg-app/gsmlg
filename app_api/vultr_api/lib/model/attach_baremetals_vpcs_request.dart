...
class AttachBaremetalsVpcsRequest {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is AttachBaremetalsVpcsRequest &&
    other.vpcId == vpcId;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "AttachBaremetalsVpcsRequest[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "AttachBaremetalsVpcsRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<AttachBaremetalsVpcsRequest> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<AttachBaremetalsVpcsRequest>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<AttachBaremetalsVpcsRequest>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = AttachBaremetalsVpcsRequest.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
