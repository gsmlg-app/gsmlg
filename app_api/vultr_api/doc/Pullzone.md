...
------------ | ------------- | ------------- | -------------
**id** | **String** | A unique ID for the CDN Pull Zone. | [optional] 
**dateCreated** | **String** | The date this CDN Pull Zone was created. | [optional] 
**status** | **String** | The current status.  * active * pending | [optional] 
**label** | **String** | The user-supplied label. | [optional] 
**originScheme** | **String** | The URI scheme of the origin domain. | [optional] 
**originDomain** | **String** | The domain name from which the content stored in the CDN will be pulled. | [optional] 
...
**lastPurge** | **String** | The last date and time that the cached content on server proxies was cleared | [optional] 
