...
// tests for BaremetalGet
void main() {
  // final instance = BaremetalGet();

  group('test BaremetalGet', () {
    ...
    // String v6Network
    test('to test the property `v6Network`', () async {
      // TODO
    });

    // The main IPv6 network address.
    // String v6MainIp
    test('to test the property `v6MainIp`', () async {
      // TODO
    });

    // The IPv6 subnet.
    // int v6NetworkSize
    test('to test the property `v6NetworkSize`', () async {
      // TODO
    });
