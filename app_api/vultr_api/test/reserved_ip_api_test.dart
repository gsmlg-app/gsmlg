...
void main() {
  ...
  group('tests for ReservedIpApi', () {
    // Attach Reserved IP
    //
    // Attach a Reserved IP to an compute instance or a baremetal instance - `instance_id`.
    //
    //Future attachReservedIp(String reservedIp, { AttachReservedIpRequest attachReservedIpRequest }) async
    test('test attachReservedIp', () async {
      // TODO
    });
    ...
    test('test convertReservedIp', () async {
      // TODO
    });
    ...
    test('test createReservedIp', () async {
      // TODO
    });
    ...
    //
    //Future deleteReservedIp(String reservedIp) async
    test('test deleteReservedIp', () async {
      // TODO
    });
    ...
    //
    //Future detachReservedIp(String reservedIp) async
    test('test detachReservedIp', () async {
      // TODO
    });
    ...
    test('test listReservedIps', () async {
      // TODO
    });
