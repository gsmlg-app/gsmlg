...
void main() {
  ...
  group('test Plans', () {
    ...
    // Map<String, PlansLocationCostValue> locationCost (default value: const {})
    test('to test the property `locationCost`', () async {
      // TODO
    });
