...
// tests for LogMetadata
void main() {
  // final instance = LogMetadata();

  group('test LogMetadata', () {
    ...
    // String requestPath
    test('to test the property `requestPath`', () async {
      // TODO
    });
    ...
    // String requestBody
    test('to test the property `requestBody`', () async {
      // TODO
    });
    ...
    test('to test the property `queryParameters`', () async {
      // TODO
    });
  });
}
