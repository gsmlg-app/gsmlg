...
// tests for LoadbalancerForwardRulesInner
void main() {
  // final instance = LoadbalancerForwardRulesInner();

  group('test LoadbalancerForwardRulesInner', () {
    ...
    test('to test the property `backendPortocol`', () async {
      // TODO
    });
